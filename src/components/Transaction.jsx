    ...
    return (
        <>
            <div>
                ...
                <br />
                <div>
                    <button type="button" class="text-black bg-slate-300  focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 ">Payouts(22)</button>
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Refund(6)</button>
                </div>
<br />
                ...
                <div className="flex flex-row justify-between">
                    <form class="flex items-center max-w-sm ">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Order Id or Transaction Id" required />
                        </div>

                    </form>
                    <div class="flex gap-4">
                        <div class="grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 rounded border border-black-150">
                            <p>Sort</p>
